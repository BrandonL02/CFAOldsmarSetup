...
#Window    
    ...
    #IPad 1
        ...
        for y in time_3to4:   
            pos_Ipad1_3to4 == pos_Ipad1_2to3 or pos_Ipad2_2to3 or pos_Ipad3_2to3
            while True:
                pos_Ipad1_3to4 = random.choice(time_3to4)
                if pos_Ipad1_3to4 != pos_Ipad1_2to3 or pos_Ipad2_2to3 or pos_Ipad3_2to3:
                    break
    ...
    #IPad 2
        ...
        for y in time_3to4:
            while pos_Ipad2_3to4 == pos_Ipad1_2to3 or pos_Ipad2_2to3 or pos_Ipad3_2to3:
                pos_Ipad2_3to4 = random.choice(time_3to4)
            else:
                    break
    ...
    #IPad 3
        ...
        for y in time_3to4:
            while pos_Ipad3_3to4 == pos_Ipad1_2to3 or pos_Ipad2_2to3 or pos_Ipad3_2to3:
                pos_Ipad3_3to4 = random.choice(time_3to4)
            else:
               break     
...
for x in time_4to5:
    ...
    #IPad 1
        ...
        for y in time_4to5:
            while pos_Ipad1_4to5 == pos_Ipad1_3to4 or pos_Ipad2_3to4 or pos_Ipad3_3to4:
                pos_Ipad1_4to5 = random.choice(time_4to5)
            else:
                break    
    ...
    #IPad 2
        ...
        for y in time_4to5:
            while pos_Ipad2_4to5 == pos_Ipad1_3to4 or pos_Ipad2_3to4 or pos_Ipad3_3to4:
                pos_Ipad2_4to5 = random.choice(time_4to5)
            else:
                break    
    ...
    #Register 2
        ...
        while pos_Register2_4to5 in Employee_name:
    ...
    #IPad 3
        ...
        for y in time_4to5:
            while pos_Ipad3_4to5 == pos_Ipad1_3to4 or pos_Ipad2_3to4 or pos_Ipad3_3to4:
                pos_Ipad3_4to5 = random.choice(time_4to5)
            else:
               break     
...
for x in time_5to6:
    ...
    #IPad 1
        ...
        for y in time_5to6:
            while pos_Ipad1_5to6 == pos_Ipad1_4to5 or pos_Ipad2_4to5 or pos_Ipad3_4to5:
                pos_Ipad1_5to6 = random.choice(time_5to6)
            else:
                break    
    ...
    #IPad 2
        ...
        for y in time_5to6:
            while pos_Ipad2_5to6 == pos_Ipad1_4to5 or pos_Ipad2_4to5 or pos_Ipad3_4to5:
                pos_Ipad2_5to6 = random.choice(time_5to6)
            else:
               break     
    ...
    #IPad 3
        ...
        for y in time_5to6:
            while pos_Ipad3_5to6 == pos_Ipad1_4to5 or pos_Ipad2_4to5 or pos_Ipad3_4to5:
                pos_Ipad3_5to6 = random.choice(time_5to6)
            else:
                break    
...
#Window    
    ...
    #IPad 1
        ...
        for y in time_6to7:
            while pos_Ipad1_6to7 == pos_Ipad1_5to6 or pos_Ipad2_5to6 or pos_Ipad3_5to6:
                pos_Ipad1_6to7 = random.choice(time_6to7) 
            else:
                break    
    ...
    #IPad 2
        ...
        for y in time_6to7:
            while pos_Ipad2_6to7 == pos_Ipad2_5to6 or pos_Ipad2_5to6 or pos_Ipad2_5to6:
                pos_Ipad2_6to7 = random.choice(time_6to7)
            else:
                break    
    ...
    #IPad 3
        ...
        for y in time_6to7:
            while pos_Ipad3_6to7 == pos_Ipad1_5to6 or pos_Ipad2_5to6 or pos_Ipad3_5to6:
                pos_Ipad3_6to7 = random.choice(time_6to7)
            else:
                break    
...
#Window    
    ...
    #IPad 1
        ...
        for y in time_7to8:
            while pos_Ipad1_7to8 == pos_Ipad1_6to7 or pos_Ipad2_6to7 or pos_Ipad3_6to7:
                pos_Ipad1_7to8 = random.choice(time_7to8)
            else:
                    break
    ...
    #IPad 2
        ...
        for y in time_7to8:
            while pos_Ipad2_7to8 == pos_Ipad1_6to7 or pos_Ipad2_6to7 or pos_Ipad3_6to7:
                pos_Ipad2_7to8 = random.choice(time_7to8)
            else:
                break
    ...
    #IPad 3
        ...
        for y in time_7to8:
            while pos_Ipad3_7to8 == pos_Ipad1_6to7 or pos_Ipad2_6to7 or pos_Ipad3_6to7:
                pos_Ipad3_7to8 = random.choice(time_7to8)
            else:
                break
...
#Window    
    ...
    #IPad 1
        ...
        for y in time_8to9:
            while pos_Ipad1_8to9 == pos_Ipad1_7to8 or pos_Ipad2_7to8 or pos_Ipad3_7to8:
                pos_Ipad1_8to9 = random.choice(time_8to9)
            else:
                    break
    ...
    #IPad 2
        ...
        for y in time_8to9:
            while pos_Ipad2_8to9 == pos_Ipad1_7to8 or pos_Ipad2_7to8 or pos_Ipad3_7to8:
                pos_Ipad2_8to9 = random.choice(time_8to9)
            else:
                break
    ...
    #IPad 3
        ...
        for y in time_8to9:
            while pos_Ipad3_8to9 == pos_Ipad1_7to8 or pos_Ipad2_7to8 or pos_Ipad3_7to8:
                pos_Ipad3_8to9 = random.choice(time_8to9)
            else:
                break
