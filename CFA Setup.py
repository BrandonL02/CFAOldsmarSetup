...
tables = doc.tables 
#Prompt user for date (Day of the Week, Month Day)
date = input("Please enter Date of Setup: ")
...
for paragraph in iter_paragraphs_of_tables(doc.tables):
     ...
     if '{{FOHCrew0}}' in paragraph.text:
         paragraph.text = paragraph.text.replace("{{FOHCrew0}}", FOHCrew[0])
     if '{{FOHCrew1}}' in paragraph.text:
         paragraph.text = paragraph.text.replace("{{FOHCrew1}}", FOHCrew[1])
     if '{{FOHCrew2}}' in paragraph.text:
         paragraph.text = paragraph.text.replace("{{FOHCrew2}}", FOHCrew[2])
     if '{{FOHCrew3}}' in paragraph.text:
         paragraph.text = paragraph.text.replace("{{FOHCrew3}}", FOHCrew[3])
     if '{{FOHCrew4}}' in paragraph.text:
         paragraph.text = paragraph.text.replace("{{FOHCrew4}}", FOHCrew[4])
     if '{{FOHCrew5}}' in paragraph.text:
         paragraph.text = paragraph.text.replace("{{FOHCrew5}}", FOHCrew[5])
     if '{{FOHCrew6}}' in paragraph.text:
         paragraph.text = paragraph.text.replace("{{FOHCrew6}}", FOHCrew[6])
     if '{{FOHCrew7}}' in paragraph.text:
         paragraph.text = paragraph.text.replace("{{FOHCrew7}}", FOHCrew[7])
     if '{{FOHCrew8}}' in paragraph.text:
         paragraph.text = paragraph.text.replace("{{FOHCrew8}}", FOHCrew[8])
     if '{{FOHCrew9}}' in paragraph.text:
         paragraph.text = paragraph.text.replace("{{FOHCrew9}}", FOHCrew[9])
     if '{{FOHCrew10}}' in paragraph.text:
         paragraph.text = paragraph.text.replace("{{FOHCrew10}}", FOHCrew[10])
     if '{{FOHCrew11}}' in paragraph.text:
         paragraph.text = paragraph.text.replace("{{FOHCrew11}}", FOHCrew[11])
     if '{{FOHCrew12}}' in paragraph.text:
         paragraph.text = paragraph.text.replace("{{FOHCrew12}}", FOHCrew[12])
     if '{{FOHCrew13}}' in paragraph.text:
         paragraph.text = paragraph.text.replace("{{FOHCrew13}}", FOHCrew[13])
     if '{{FOHCrew14}}' in paragraph.text:
         paragraph.text = paragraph.text.replace("{{FOHCrew14}}", FOHCrew[14])
if '{{Date}}' in paragraph.text:
  paragraph.text = paragraph.text.replace("{{Date}}", date)            
font = paragraph.style.font         
font.size = Pt(9)         
doc.save('FOHSetup.docx')         
os.startfile('C:/Users/Brand/Documents/FOHSetup.docx')
