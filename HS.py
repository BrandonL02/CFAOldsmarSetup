...
#Print Data for html and Info.text for only text
#print (Info.text)
emp_working = (Info.text)

if 'FOH General' in emp_working:
  emp_working = emp_working.replace("FOH General", "")
...
#Names in Dictionary
full_schedule = {}
days = "{'Sunday' : 'x' , 'Monday' : 'x', 'Tuesday' : 'x' , 'Wednesday' : 'x' , 'Thursday' : 'x' , 'Friday' : 'x' , 'Saturday' : 'x'}"
for x in range (1,57):
